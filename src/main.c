...
int main(void) {
  ...
  while(1) {
    ...
    if (inactivity_timeout_counter % 25 == 0) {
      ...
      #endif
      #ifdef CONTROL_PPM
      setScopeChannel(0, (int)ppm_captured_value[5]);
      setScopeChannel(1, (int)ppm_captured_value[6]);
      setScopeChannel(9,(int)ppm_captured_value[7]);
      setScopeChannel(10,(int)ppm_captured_value[8]);
      #endif
